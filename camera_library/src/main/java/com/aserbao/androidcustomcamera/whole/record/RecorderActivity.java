...
public class RecorderActivity extends BaseActivity implements View.OnTouchListener, SlideGpuFilterGroup.OnFilterChangeListener {
    ...
    public void onViewClicked(View view) {
        ...
        int i = view.getId();
        if (i == R.id.matching_back) {
            onBackPressed();
        } else if (i == R.id.video_record_finish_iv) {
            onStopRecording();
            if (mMediaObject != null) {
        ...
        } else if (i == R.id.custom_record_image_view) {
            if(!isRecording) {
                onStartRecording();
            }else{
                onStopRecording();
            }
        } else if (i == R.id.count_down_tv) {
