...
import com.aserbao.androidcustomcamera.Constants;
...
import com.aserbao.androidcustomcamera.http.API;
...
public class VideoPlayerActivity2 extends AppCompatActivity  {
    ...
    private String  videoFilePath = Constants.VIDEO_File_Path, mOnLineVideoFilePath;
    ...
    public void onViewClicked(View view) {
        int i = view.getId();
        if (i == R.id.video_player2_edit_video_tv) {
        ...
        } else if (i == R.id.video_player2_sel_cover) {
            ...
            onBackPressed();
        } else if (i == R.id.video_player_tv_storage) {
        } else if (i == R.id.video_player_tv_public) {
            storeToPhoto(videoFilePath);
            API.getInstance().upLoadFileList(mContext, new File(videoFilePath), new MyCallBack<String>() {
                @Override
