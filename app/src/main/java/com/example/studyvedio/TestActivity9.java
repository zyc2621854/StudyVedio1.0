...
import com.aserbao.androidcustomcamera.MainActivity;
...
import com.example.studyvedio.widget.ChatView;
...
public class TestActivity9 extends BaseActivity implements View.OnTouchListener,
    ...
    protected void initView() {
        ...
        mChatView.setMenuClickListener(new OnMenuClickListener() {
            ...
            public void onSendFiles(List<FileItem> list) {
                ...
                for (FileItem item : list) {
                    ...
                    TestActivity9.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
            ...
            public boolean switchToMicrophoneMode() {
                ...
                if (!EasyPermissions.hasPermissions(TestActivity9.this, perms)) {
                    EasyPermissions.requestPermissions(TestActivity9.this,
        ...
        mChatView.getSelectAlbumBtn().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(TestActivity9.this, "OnClick select album button",
    ...
    private final static String TAG = "TestActivity9";
...
//                        Intent intent = new Intent(TestActivity9.this, VideoActivity.class);
...
//                    Intent intent = new Intent(TestActivity9.this, BrowserImageActivity.class);
...
//                }
        ...
        layout.setPtrHandler(new PtrHandler() {
            ...
            public void onRefreshBegin(PullToRefreshLayout layout) {
                Log.i("TestActivity9", "Loading next page");
                loadNextPage();
            }
        });
